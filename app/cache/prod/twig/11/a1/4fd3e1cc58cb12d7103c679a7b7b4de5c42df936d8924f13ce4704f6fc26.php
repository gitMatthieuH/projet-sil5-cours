...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["chapeaux"]) ? $context["chapeaux"] : null));
        foreach ($context['_seq'] as $context["_key"] => $context["chapeau"]) {
            // line 17
            echo "\t    \t<a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("sil12_vitrine_chapeau", array("id" => $this->getAttribute($this->getAttribute((isset($context["chapeau"]) ? $context["chapeau"] : null), "chapeau"), "id"))), "html", null, true);
...
\t\t    \t\t<img src=\"";
            ...
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["chapeau"]) ? $context["chapeau"] : null), "chapeau"), "id"), "html", null, true);
...
\t\t\t\t\t\t<h2>";
            // line 22
            echo twig_escape_filter($this->env, twig_truncate_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["chapeau"]) ? $context["chapeau"] : null), "chapeau"), "name"), 30), "html", null, true);
            echo "</h2>
\t\t\t\t\t\t<p>";
            // line 23
            echo twig_escape_filter($this->env, twig_truncate_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["chapeau"]) ? $context["chapeau"] : null), "chapeau"), "description"), 40), "html", null, true);
            echo "</p>
\t\t\t\t\t\t";
            // line 24
            if ((twig_length_filter($this->env, $this->getAttribute((isset($context["chapeau"]) ? $context["chapeau"] : null), "proms")) > 0)) {
                // line 25
                echo "\t\t\t\t\t\t\t";
                $context["price"] = $this->getAttribute($this->getAttribute((isset($context["chapeau"]) ? $context["chapeau"] : null), "chapeau"), "price");
                // line 26
                echo "\t\t\t\t\t\t\t";
                $context['_parent'] = (array) $context;
                $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["chapeau"]) ? $context["chapeau"] : null), "proms"));
...
\t\t\t\t\t\t\t\t";
                ...
                // line 30
                echo "\t\t\t\t\t\t\t<p><b>Prix : </b><s>";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["chapeau"]) ? $context["chapeau"] : null), "chapeau"), "price"), "html", null, true);
