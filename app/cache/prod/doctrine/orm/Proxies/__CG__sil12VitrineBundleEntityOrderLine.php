 ...
 */
class OrderLine extends \sil12\VitrineBundle\Entity\OrderLine implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'quantity', 'price', 'orderhat', 'product');
        }
    ...
    public function setOrderhat(\sil12\VitrineBundle\Entity\Orderhat $orderhat = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrderhat', array($orderhat));

        return parent::setOrderhat($orderhat);
    }
    ...
    public function getOrderhat()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrderhat', array());

        return parent::getOrderhat();
    }
