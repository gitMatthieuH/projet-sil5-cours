 ...
 */
class Orderhat extends \sil12\VitrineBundle\Entity\Orderhat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'actAs', 'validated', 'orderline', 'client', 'order_date');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Orderhat $proxy) {
    ...
    public function setActAs($actAs)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setActAs', array($actAs));

        return parent::setActAs($actAs);
    }
    ...
    public function getActAs()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActAs', array());

        return parent::getActAs();
    }
