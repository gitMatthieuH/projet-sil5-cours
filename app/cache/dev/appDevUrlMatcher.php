        ...
        if (0 === strpos($pathinfo, '/c')) {
            if (0 === strpos($pathinfo, '/cat')) {
                ...
                if (0 === strpos($pathinfo, '/category')) {
                    ...
                    if ($pathinfo === '/categoryFiltered') {
                        if ($this->context->getMethod() != 'POST') {
                            $allow[] = 'POST';
                            goto not_sil12_vitrine_filteredArticlesParCategorie;
                        }

                        return array (  '_controller' => 'sil12\\VitrineBundle\\Controller\\DefaultController::filteredArticlesParCategorieAction',  '_route' => 'sil12_vitrine_filteredArticlesParCategorie',);
                    }
                    not_sil12_vitrine_filteredArticlesParCategorie:
